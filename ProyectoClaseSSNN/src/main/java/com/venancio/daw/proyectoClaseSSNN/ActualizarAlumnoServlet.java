...
public class ActualizarAlumnoServlet extends GenericServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        engine.process("actualizarAlumno", ctx, response.getWriter());
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
    	...
    	try {
            ...
            cs.modificarAlumno(a.getCodigoAlumno(), a.getNombre(), a.getApellidos(), a.getTelefono(), a.getFechaNacimiento());
